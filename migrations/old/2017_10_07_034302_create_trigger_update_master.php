        ...
        DB::unprepared('
            ...
            BEGIN
                ...
                BEGIN 
                    ...
                    INSERT INTO 
                    historymaster (
                        master_code,name,lastname,lvlstudy_id,profesion_id,ocupacion_id,estamento_id,location_id,level_id,funcdir_id,fie,fiu,employee_id,imgfile,docident_id,docident_nmb,lm,ruc,essalud,banco_id,account_id,account_nmb,cci,life_insurance,ent_id,seg_id,disability,discp_id,did,syndicated,sindicato_id,regpen_id,cuspp,since,until,number_license,category_license,sex,civil_status,blood_type,birthdate,country_id,city,department_id,province_id,district_id,vivepd,namep,lastnamep,vivemd,namem,lastnamem,created_at,updated_at
                    ) 
                    SELECT 
                        codigo,name,lastname,lvlstudy_id,profesion_id,ocupacion_id,estamento_id,location_id,level_id,funcdir_id,fie,fiu,employee_id,imgfile,docident_id,docident_nmb,lm,ruc,essalud,banco_id,account_id,account_nmb,cci,life_insurance,ent_id,seg_id,disability,discp_id,did,syndicated,sindicato_id,regpen_id,cuspp,since,until,number_license,category_license,sex,civil_status,blood_type,birthdate,country_id,city,department_id,province_id,district_id,vivepd,namep,lastnamep,vivemd,namem,lastnamem,CAST(GETDATE() AS DATE),CAST(GETDATE() AS DATE) 
                    FROM 
                        INSERTED 
                END
            END
