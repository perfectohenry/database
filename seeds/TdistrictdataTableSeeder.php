...
class TdistrictdataTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('tdistrictdata')->delete();
        
        \DB::table('tdistrictdata')->insert(array (
            0 => 
            array (
                'id' => 1,
                'province_id' => 1,
        ...
        \DB::table('tdistrictdata')->insert(array (
            ...
            array (
                'id' => 1789,
                'province_id' => 187,
                'district' => 'Crnl. Gregorio Albarracin Lanchipa',
                'created_at' => NULL,
                'updated_at' => NULL,
            ),
            289 => 
